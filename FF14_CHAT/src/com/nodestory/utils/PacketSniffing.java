...
public class PacketSniffing {
	...
	/**
	 * <pre>
	 *     Å¬¶óÀÌ¾ğÆ®¿¡¼­ ¼­¹ö·Î º¸³»´Â ÆĞÅ¶
	 *     ÁÖ·Î »ç¿ëÀÚ°¡ ÀÔ·ÂÇÑ Ã¤ÆÃ ¸Ş¼¼Áö¸¦ º¸³»´Â ÆĞÅ¶À» ºĞ¼®ÇÑ´Ù.
	 * </pre>
	 * 
	 * @param packet
	 *            - ÆĞÅ¶
	...
	public void sendPacketToServer(PcapPacket packet, String sourceIP, String destinationIP) {
		...
		if (packet.size() == 1158) {
			...
			// ¼­¹ö·Î Àü¼ÛÇÏ´Â ³»°¡ ÀÔ·ÂÇÑ ¸Ş¼¼Áö
			String chatMsg = fromClientHexToServerMsg(hexdump);

			// ³»°¡ Àü¼ÛÇÏ´Â ¹®ÀÚ¿¡ ÇÑ±ÛÀÌ³ª ¼ıÀÚ ¿µ¾î(´ë¼Ò¹®ÀÚ) °ø¹éÀÌ ÀÖ´ÂÁö¸¸
			...
			if (chatMsg.matches(reg)) {
				...
				// º¸³»´Â ÆĞÅ¶Àº ÆÄÆ¼Ãª °ú ºÎ´ëÃª »çÀÌÁî°¡ µ¿ÀÏÇÏ¹Ç·Î, ±¸ºĞ°ªÀ» Á¤ÇØ¼­ È­¸é¿¡ º¸¿©ÁÖ´Â°É

				// ÆÄ½ÌµÈ ÆĞÅ¶¿¡ "01" ÆĞÅ¶ÀÌ ÀÖ´ÂÁö Ã¼Å©
	...
	/**
	 * <pre>
	 *     ¼­¹ö¿¡¼­ Å¬¶óÀÌ¾ğÆ®·Î º¸³»´Â ÆĞÅ¶
	 *     ÁÖ·Î ´Ù¸¥ »ç¿ëÀÚ°¡ ÀÔ·ÂÇÑ Ã¤ÆÃ ¸Ş¼¼Áö¸¦ º¸³»´Â ÆĞÅ¶À» ºĞ¼®ÇÑ´Ù. (ÆÄÆ¼, FC)
	 * </pre>
	 * 
	 * @param packet-
	 *            ÆĞÅ¶
	...
	public void receivePacketToClient(PcapPacket packet, String sourceIP, String destinationIP) {
		...
		if (packet.size() == 1206 && !sourceIP.matches(".*216.58.*")) {
			...
			// ¼­¹ö¿¡¼­ Àü¼ÛÇÏ´Â ¹®ÀÚ¿¡ ÇÑ±ÛÀÌ³ª ¼ıÀÚ ¿µ¾î(´ë¼Ò¹®ÀÚ), ÁöÁ¤µÈ Æ¯¹®ÀÌ³ª °ø¹éÀÌ ÀÖ´ÂÁö¸¸
			String reg = "[¤¡-¤¾|¤¿-¤Ó|°¡-ÆR|0-9|a-z|A-Z|\\s|!@#$%^&*()+-.]*";
			if (chatMsg.matches(reg)) {
				...
				// ¹Ş´Â ÆĞÅ¶Àº ÆÄÆ¼Ãª °ú ºÎ´ëÃª »çÀÌÁî°¡ µ¿ÀÏÇÏ¹Ç·Î, ±¸ºĞ°ªÀ» Á¤ÇØ¼­ È­¸é¿¡ º¸¿©ÁÖ´Â°É ´Ş¸®ÇØ¾ßÇÑ´Ù.
				// ÆÄ½ÌµÈ ÆĞÅ¶¿¡ "01" ÆĞÅ¶ÀÌ ÀÖ´ÂÁö Ã¼Å©
				if (parsePacket.indexOf("01") > -1) {
					// ÀÖ´Ù¸é ÆÄÆ¼ Ãª ¸®½Ãºê
	 ...
	 * @param hexdump
	 *            - ÆĞÅ¶´ıÇÁ
	 * @return ¹ÙÀÌÆ® ¹è¿­À» UTF-8·Î º¯È¯ÇÑ ¸Ş½ÃÁö
	 */
	...
	/**
	 * ¼­¹ö¿¡¼­ Å¬¶óÀÌ¾ğÆ®·Î º¸³½ ÆĞÅ¶ Áß Ä³¸¯ÅÍ¸íÀ» ÆÄ½ÌÇÔ
	 * 
	 * @param hexdump
	 *            - ÆĞÅ¶´ıÇÁ
	 * @return ¹ÙÀÌÆ® ¹è¿­À» UTF-8·Î º¯È¯ÇÑ ¸Ş½ÃÁö
